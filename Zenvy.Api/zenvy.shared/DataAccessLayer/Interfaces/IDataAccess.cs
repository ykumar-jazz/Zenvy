...
namespace DataAccessLayer.Interfaces
{
    ...
    public interface IDataAccess
    {
        ...
        /// Executes a command and returns a DataTable
        /// </summary>
        /// <param name="cmd">Output parameter that holds ref public DbParameter Create(string paramName, SqlDbType erence to the command object just executed</param>
        /// <param name="commandText">command text to execute</param>
        ...
        /// <param name="commandText">command text to execute</param>
        /// <param name="parameters">DbParameter collection to use in executing</param>
        /// <returns>SqlDataReader allowing access to results from command with Aysnc</returns>

        Task<DbDataReader> ExecuteReaderAysnc(string commandText, params DbParameter[] parameters);
